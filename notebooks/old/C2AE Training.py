...
# el 4 de sept use este script para correr c2ae en todos los sets de patterns as features, el notebook dsps mejoró
#tambien lo intente usar el mismo dia para los sets de features alexnet pretrained (no retrained) pero termine copiando
#el notebook de nuevo
DSFLAGS = [['base'],
           ['blur'],
