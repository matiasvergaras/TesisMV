        ...
        for i in LABELS_IN_STUDY:
          ...
          for meth_name, method in ADAPT_METHODS.items():
                ...
                for i in range(0, K):
                    ...
                    mr1 = metrics.k_match_ratio(1)
                    mr2 = metrics.k_match_ratio(2)
                    mr3 = metrics.k_match_ratio(3)
                    mr4 = metrics.k_match_ratio(4)
                    mr5 = metrics.k_match_ratio(5)
